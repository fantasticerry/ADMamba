...
train_dataset = PotsdamDataset(data_root=f"{dataset_root}/train", mode='train',
                               mosaic_ratio=0.25, transform=train_aug)

val_dataset = PotsdamDataset(data_root=f"{dataset_root}/test", transform=val_aug)
test_dataset = PotsdamDataset(data_root=f"{dataset_root}/test", transform=val_aug)
